...
async function getAdminStats() {
  ...
  return { pendingApps, approvedApps, totalMentors, totalStudents, totalSubAdmins };
}
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="shadow-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">{stats.approvedApps} applications approved</p>
          </CardContent>
        </Card>
        ...
        {/* Card 4: Staff (Only Admin cares about this usually) */}
